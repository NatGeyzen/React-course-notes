...
// new component, using styled-components library syntax to specify css rules
...
`;
    // rules were taken from style object inside render, adjusted to CSS code instead of JS
...
class App extends Component {
  ...
  render() {
    ...
    // button replaced by StyledButtom component
    return (
        <div className="App">
